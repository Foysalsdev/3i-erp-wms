...
export default function InboundPage() {
  ...
  const active = tab && tabs.some(t => t.key === tab) ? tab : 'purchase-requisition'

  return (
    <div className="space-y-4">
      <PageHeader icon="login" title="Inbound Operations" subtitle="Requisitions, goods receipt, putaway & returns" />
