  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
        <Kpi icon="inventory_2" label="Active SKUs" value={formatNumber(kpi.skus)} hint="catalogue items" />
        <Kpi icon="stacks" label="Total on-hand" value={formatNumber(kpi.onHand)} hint={`across ${kpi.warehouses} warehouse(s)`} />
