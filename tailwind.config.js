...
export default {
  ...
  theme: {
    extend: {
      ...
      borderRadius: { xl: '14px', '2xl': '18px', '3xl': '24px', card: '16px' },
      boxShadow: {
        soft: '0 1px 2px rgba(0,0,0,0.06), 0 1px 3px rgba(0,0,0,0.05)',
        card: '0 2px 4px rgba(0,0,0,0.04), 0 12px 28px -10px rgba(0,0,0,0.14)',
        pop: '0 8px 16px -4px rgba(0,0,0,0.12), 0 24px 48px -12px rgba(0,0,0,0.28)',
        glow: '0 6px 22px -4px rgba(242,169,0,0.55)',
        fiori: '0 2px 4px rgba(0,0,0,0.04), 0 12px 28px -10px rgba(0,0,0,0.14)',
        'fiori-lg': '0 8px 16px -4px rgba(0,0,0,0.12), 0 24px 48px -12px rgba(0,0,0,0.28)'
      },
      backgroundImage: {
